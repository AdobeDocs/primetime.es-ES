...
+ Ad Insertion de Primetime {#ptai}
   + [Notas de la versión de PTAI 22.9.2](ptai-22x-release-notes.md)
   + [Notas de la versión de PTAI 21.11.1](ptai-21x-release-notes.md)
...
+ TVSDK para HLS de escritorio {#tvsdk-desktop-hls}
   + [Notas de la versión de TVSDK 1.4 para HLS de escritorio](tvsdk-1-4-desktop-hls.md)
+ Empaquetador sin conexión de Primetime {#offline-packager}
   + [Versiones de Primetime Offline Packager versión 2](offline-packager-2x-release-note.md)
+ Servidor de streaming de Primetime {#streaming-server}
