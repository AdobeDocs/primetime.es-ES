...
Para obtener más información, consulte [Ad fallback for VAST and VMAP ads](../programming/tvsdk-1.4-for-ios/ad-insertion/c-psdk-ios-1.4-ad-fallback.md).
...
* (ZD# 27460) Llamada de primer anuncio de anuncio de anuncio de anuncio medio - POST a cdn.auditude<span></span>.com que devuelve 403.
