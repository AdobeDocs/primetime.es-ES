...
Configure el firewall externo de modo que muestre únicamente las direcciones URL para la funcionalidad de la aplicación que desea proporcionar a los usuarios finales. Permitir a los usuarios externos acceder a través del firewall externo solo a las direcciones URL enumeradas en la siguiente tabla:
...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table-bqs-whz-n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">URL para la autenticación de usuarios. Solo se puede acceder a esta dirección URL si se usan las API de cliente de acceso a Adobe para realizar la autenticación de usuario. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul-yxs-rdn-44"> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">URL para solicitudes de sincronización. Solo se puede acceder a esta dirección URL si se especifican los requisitos de sincronización en las licencias. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul-plq-ydn-44"> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">URL para el registro de dominios. Solo se puede acceder a esta dirección URL si se implementa la compatibilidad con el dominio. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul-btm-c2n-44"> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Direcciones URL para la anulación de registro de dominios. Solo se puede acceder a esta dirección URL si se implementa la compatibilidad con el dominio. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /flashaccess/headerconversion/v1/*</span> </td> 
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Direcciones URL que utiliza el cliente para convertir metadatos DRM de FMRMS 1.x a metadatos DRM de acceso a Adobe. </p> <p class="- topic/p ">Nota: <i class="+ topic/ph hi-d/i ">Esta URL debe utilizar SSL (HTTPS)</i>. </p> </td> 
  </tr> 
  <tr rowsep="0" class="- topic/row "> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /edcws/services/urn:EDCLicenseService/*</span> </td> 
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">URL del servicio web de LiveCycle Rights Management ES. Si el contenido se publicó con una versión anterior de FMRMS, esta URL permite que los clientes más antiguos se conecten al servidor y se les pida que actualicen a Acceso a Adobe. </p> <p class="- topic/p ">Nota: <i class="+ topic/ph hi-d/i ">Esta URL debe utilizar SSL (HTTPS)</i>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /flashaccess/lreturn/v5</span> </td> 
   <td colname="2" class="- topic/entry "> <p>URL de devolución de licencia. La dirección URL solo debe ser accesible si implementa la compatibilidad con la devolución de licencias. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>El cortafuegos interno solo debe permitir que las conexiones se realicen al servidor de licencias de acceso a Adobe a través del proxy inverso y solo a las URL enumeradas anteriormente. Para mejorar la escalabilidad, las conexiones entre el proxy inverso y el acceso al Adobe se realizarán a través de HTTP.

## Direcciones URL salientes {#section-FFF9F7BB353149F4A27F8788E9934A48}

El servidor de licencias requiere acceso a través del cortafuegos para descargar las siguientes listas CRL desde el Adobe:
