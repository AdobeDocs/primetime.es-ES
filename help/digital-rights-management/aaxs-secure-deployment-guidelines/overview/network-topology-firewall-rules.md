...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table-bqs-whz-n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Direcciones URL para la autenticación de usuarios. Esta dirección URL solo debe ser accesible si utiliza las API del cliente de acceso a Adobe para realizar la autenticación de usuarios. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "> 
    <ul id="ul-yxs-rdn-44"> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Direcciones URL que utiliza el cliente para convertir metadatos DRM de FMRMS 1.x a metadatos DRM de acceso a Adobe. </p> <p class="- topic/p ">Nota: <i class="+ topic/ph hi-d/i ">Esta dirección URL debe utilizar SSL (HTTPS)</i>. </p> </td> 
  </tr> 
  <tr rowsep="0" class="- topic/row "> 
   <td colname="1" class="- topic/entry "><span class="filepath"> /edcws/services/urn:EDCLicenseService/*</span> </td> 
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">URL del servicio web de LiveCycle Rights Management ES. Si el contenido se publicó con una versión anterior de FMRMS, esta URL permite que los clientes más antiguos se conecten al servidor y se les pregunte si desean actualizar a Adobe Access. </p> <p class="- topic/p ">Nota: <i class="+ topic/ph hi-d/i ">Esta dirección URL debe utilizar SSL (HTTPS)</i>. </p> </td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>El servidor de seguridad interno solo debe permitir que las conexiones se realicen al servidor de licencias de Adobe Access a través del proxy inverso y solo a las direcciones URL enumeradas anteriormente. Para mejorar la escalabilidad, las conexiones entre el proxy inverso y Adobe Access estarán a través de HTTP.
