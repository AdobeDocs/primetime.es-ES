---
description: Con Adobe Primetime DRM SDK, debe crear un servidor de licencias. Cuando el contenido está protegido con Primetime DRM, no se puede ver hasta que el servidor de licencias emita una licencia para el consumidor. Si se utiliza la licencia basada en la identidad, la autenticación basada en contraseña garantiza que solo los consumidores autorizados puedan abrir y ver el contenido.
