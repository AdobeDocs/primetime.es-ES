...
* **Codificadores**  de hardware y software: codificadores que implementan el  [SDK de DRM de Adobe Primetime ](https://helpx.adobe.com/content/dam/help/en/primetime/drm/drm_sdk_overview.pdf) o el SDK de retransmisión de Adobe (HDKb).