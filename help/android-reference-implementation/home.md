...
Le damos la bienvenida a la ayuda de Implementación de referencia para Adobe Primetime. Los documentos enumerados en la navegación izquierda ayudan a comprender el SDK de TVSDK y a modificar los administradores de funciones para personalizar su reproductor personal.
