---
description: Esta tabla proporciona información detallada sobre INFO. escribir notificaciones.
...
Esta tabla proporciona información detallada sobre INFO. escribir notificaciones.
...
<table frame="all" colsep="1" rowsep="1" id="table_503463046E764A87B10EB5D8B294EB23"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="4"><span class="codeph"> CONTENT_ID_CURRENT_MEDIA_TIME </span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> ha aceptado una pausa publicitaria propuesta <code>primetime-sdk-name</code> y se colocan (en su totalidad o solo parcialmente) en la cronología de reproducción. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> <p>Ninguno </p> </td> 
   <td colname="4"> <span class="codeph"> TIPO</span> <p><span class="codeph"> ID</span> </p> <span class="codeph"> NOMBRE</span> <p><span class="codeph"> HORA</span> </p> </td> 
   <td colname="5"> Se detectó un nuevo metadato cronometrado en el manifiesto. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="5"> Devuelve información sobre un anuncio en el que hizo clic el usuario. </td> 
  </tr> 
  <tr rowsep="1"> 
