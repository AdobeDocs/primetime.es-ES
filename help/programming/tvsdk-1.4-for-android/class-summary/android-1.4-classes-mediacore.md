...
Para ver la documentación completa de la API para TVSDK, vaya a las [Referencias de la API de Adobe Primetime](https://help.adobe.com/en_US/primetime/api/index.html#api-Adobe_Primetime_API_References).
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/BufferControlParameters.html" format="html" scope="external"> Parámetros de BufferControl</a> </span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Implementación de clase predeterminada de la interfaz <span class="codeph"> MediaPlayer</span>. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">Interfaz pública para la clase <span class="codeph"> DefaultMediaPlayer</span>. Incluye listas desglosadas para Evento, PlayerState y Visibilidad. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interfaz de marcador utilizada para unificar el registro de oyentes de evento. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Clase que envuelve toda la información sobre un recurso de medios. Incluye lista desglosada para el tipo de recurso de medios. </td> 
  </tr> 
  <tr rowsep="1"> 
