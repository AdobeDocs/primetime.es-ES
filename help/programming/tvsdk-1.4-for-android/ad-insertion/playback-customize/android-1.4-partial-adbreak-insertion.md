---
description: Puede habilitar una experiencia similar a la de una TV de poder unirse en medio de un anuncio o en emisiones en directo.
...
Puede habilitar una experiencia similar a la de una TV de poder unirse en medio de un anuncio o en emisiones en directo.

La función de pausa parcial para anuncios le permite imitar una experiencia similar a una TV en la que, si el cliente inicia una emisión en directo dentro de un midroll, esta se inicia dentro de ese midroll. Es similar a cambiar a un canal de TV y los anuncios se ejecutan sin problemas.
...
1. Esta función requiere que implemente un selector de políticas de publicidad personalizado para personalizar el comportamiento. Si todavía no tiene una implementación personalizada de la clase AdvertisingFactory, agregue una nueva implementación de AdvertisingFactory. Reemplace el método createAdPolicySelector. Este método devuelve una nueva instancia de la implementación de AdPolicySelector.

   A continuación se proporciona una implementación de muestra para su referencia. La siguiente implementación de ejemplo está disponible para su uso en el paquete com.adobe.mediacore. Sin embargo, se simplifica para facilitar la referencia y no se recomienda utilizarlo tal cual.

   1. Selector de políticas de publicidad de muestra
   ...
   1. Fábrica de publicidad de muestra
   ...
   1. Registre nuestra Advertising Factory con el reproductor de medios
   ...
   1. Anular el método createAdPolicySelector
