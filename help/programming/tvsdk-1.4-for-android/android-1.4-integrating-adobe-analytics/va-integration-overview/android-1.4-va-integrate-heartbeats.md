...
<table id="table_3565328ABBEE4605A92EAE1ADE5D6F84"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Importante:  Este nombre de archivo de configuración JSON debe ser <span class="codeph"> ADBMobileConfig.json </span>. No se puede cambiar el nombre y la ruta de este archivo de configuración. La ruta de acceso a este archivo debe ser <span class="codeph"> &lt;raíz de origen&gt;/assets </span>. </p> </td> 
  </tr> 
  <tr> 
