...
* `NetworkConfiguration.urlTransformer` Método setter que se proporciona en la instancia de `NetworkConfiguration` metadatos para establecer la implementación `URLTransformer` .
