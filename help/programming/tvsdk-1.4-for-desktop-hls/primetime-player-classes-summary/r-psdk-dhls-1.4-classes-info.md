...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Clase que extiende Track para definir la abstracción de subtítulos opcionales. Una pista de subtítulos cerrados se define exclusivamente por su nombre Y su tipo de servicio. Diferentes tipos de servicio pueden compartir el mismo nombre.</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Clase que contiene los tipos de pistas de subtítulos opcionales predeterminados. </td> 
  </tr> 
  <tr rowsep="1"> 
