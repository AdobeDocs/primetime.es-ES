...
<table> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Valor para la clave de metadatos RUNTIME_CODE </th> 
   <th colname="col2" class="entry"> Valor para la clave de metadatos RUNTIME_CODE_MESSAGE </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> El lector de medios no puede cargar segmentos porque ha llegado al final de la ventana activa. La carga de segmentos se reanudará cuando el servidor añada nuevos medios a la ventana activa. Normalmente, este estado se alcanza si: 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">El siguiente periodo es un periodo activo con un reemplazo de medios pendiente (debido a la <span class="codeph"> llamada de API InsertBy</span>) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> La reproducción de HLS no se ha habilitado en el Flash Player. Consulte <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>. </td> 
  </tr> 
  <tr> 
