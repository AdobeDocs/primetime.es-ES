...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> El lector de medios no puede leer más porque ha alcanzado la hora establecida por la API <span class="codeph"> setHoldAt</span> . </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> El lector de medios no puede cargar segmentos porque ha llegado al final de la ventana activa. La carga de segmentos se reanudará cuando el servidor añada nuevos medios a la ventana activa. Este estado suele alcanzarse si: 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">El período siguiente es un período activo con un reemplazo de medios pendiente (debido a la llamada de la API <span class="codeph"> InsertBy</span> ) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> La reproducción de HLS no se ha activado en Flash Player. Consulte <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>. </td> 
  </tr> 
  <tr> 
