...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">Para obtener más información, consulte <a href="../../tvsdk-2.7-for-android/content-playback-options/ui-configure/t-psdk-android-2.7-ui-seek-scrub-bar-display.md" format="dita" scope="local"> Mostrar una barra de búsqueda con desplazamiento con la posición de reproducción actual...</a> </td> 
  </tr> 
 </tbody> 
</table>