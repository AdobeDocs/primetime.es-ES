...
Le damos la bienvenida a la ayuda de migración y conversión para Adobe Primetime. Los documentos enumerados en la navegación izquierda explican el proceso de conversión y migración para pasar de su grupo de TVSDK de Primetime existente al grupo de próxima generación.
