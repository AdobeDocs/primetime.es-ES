---
title: Restringir el uso simultáneo con varias aplicaciones que pertenecen a propietarios diferentes
description: Restricción del uso simultáneo con varias aplicaciones que pertenecen a propietarios diferentes
...
# Restricción del uso simultáneo con varias aplicaciones que pertenecen a propietarios diferentes {#restr-concurr-usage}
...
Para integrarse con CM, se deberá crear un ticket de Zendesk (https://adobeprimetime.zendesk.com) y especificar la siguiente información:

1. el nombre de la empresa
1. las aplicaciones que desea integrar con CM. Para cada solicitud, debe proporcionar lo siguiente:
   - nombre de aplicación
   - plataforma de aplicación
1. el tercero que solicitó la integración (si corresponde)


Después de crear el ticket, se libera la siguiente información para su uso:

| type | description | valor de ejemplo | valor predeterminado |
| --- | --- | --- | --- |
| punto final | el punto final para la Monitorización de concurrencia de Adobe | http://streams.adobeprimetime.com/v1/ | http://streams.adobeprimetime.com/v1/ |
...
Los siguientes artículos DEBEN ser empaquetados en la(s) aplicación(es):

1. punto final
1. ID de aplicación
1. intervalo para latidos
1. intervalo para comprobar el cumplimiento
